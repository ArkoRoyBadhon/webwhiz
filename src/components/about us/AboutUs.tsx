...
const AboutSection = () => {
  ...
  return (
    <section className="container-mobile lg:container section-spacing-mobile lg:section-spacing pt-[76px]">
      <div className="section-name text-center lg:text-left">about us</div>
      <div className="flex flex-col md:flex-row items-center justify-between mb-[4px]">
        <div className="w-[327px] lg:w-[564px] text-custom-black text-[24px] lg:text-[40px] font-extrabold leading-[140%] text-center lg:text-left">
          <p className="">
        ...
        <div className="relative">
          <div className="hidden lg:block lg:absolute w-[4px] h-[65px] left-0 top-1 custom-bg-gradient rounded-[16px] mt-[-21px]"></div>
      ...
      <div className="flex flex-col lg:flex-row justify-between mt-[48px] gap-[32px]">
        ...
        <div className="relative">
          <Image
            ...
            width={626}
          />
          <div className="absolute custom-bg-gradient flex w-[349px] lg:w-[532px] justify-between items-center rounded-[12px] right-[-12px] lg:right-[-51px] bottom-[0px] lg:bottom-[-24px] p-[16px] lg:p-[31px]">
            {AboutUsData &&
              AboutUsData.map((item, i) => {
                return (
                  <div
                    className={`relative px-[16px] ${i === 0 && "pl-[0.5px]"}`}
                  >
                    {i > 1 ? (
                      <></>
                    ) : (
                      <div className="absolute w-[2px] h-[60px] rounded-[16px] bg-light-grey right-[16px] lg:right-[-31px]"></div>
                    )}
