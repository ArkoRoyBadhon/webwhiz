...
const BlogSection = () => {
  ...
  return (
    <section className="container section-spacing-mobile lg:section-spacing pt-[200px] lg:pt-[130px]">
      <div className="flex flex-col-reverse md:flex-row justify-between relative">
        <div className="">
          <div className="absolute top-[340px] lg:top-[136px] w-[327px] lg:w-[554px] h-[287px] lg:h-[450px] rounded-[16px] bg-[#EDEEFB]"></div>
          <div className="absolute left-[40px] lg:left-[93px] top-[235px] lg:top-[0px]">
            <Image
          ...
          <div className="absolute bottom-[-415px] lg:bottom-[-22px] custom-center gap-[8px] left-[75px] lg:left-[194px]">
            <div
        ...
        <div className="relative lg:mt-[220px]">
          ...
          <div className="absolute lg:relative bottom-[-500px] lg:bottom-0 left-[95px] flex gap-[12px] items-center mt-[38px]">
