...
const BlogSection = () => {
  ...
  return (
    <section>
      <div className="container section-spacing-mobile lg:section-spacing pt-[200px] md:pt-0 lg:pt-[150px]">
        <div className="flex flex-col-reverse md:flex-row justify-between relative">
          ...
          <div className="relative md:mt-[100px] lg:mt-[220px]">
            ...
            <div className="absolute lg:relative bottom-[-500px] md:bottom-[-50px] lg:bottom-0 left-[90px] flex gap-[12px] items-center mt-[40px]">
