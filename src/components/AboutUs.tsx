...
const AboutSection = () => {
  ...
  return (
    <section>
      <div className="container section-spacing-mobile lg:section-spacing pt-[53px] lg:pt-[53px]">
        ...
        <div className="flex flex-col md:flex-row justify-between mt-[48px] gap-[32px]">
          ...
          <div className="relative">
            <Image
              ...
              width={626}
            />
            <div className="absolute custom-bg-gradient flex w-[349px] lg:w-[532px] justify-between items-center rounded-[12px] right-[-12px] md:right-[8px] lg:right-[-51px] bottom-[0px] md:bottom-[25px] lg:bottom-[-30px] py-[16px] lg:py-[36px] lg:px-[31px]">
              {AboutUsData &&
                AboutUsData.map((item, i) => {
                  return (
                    ...
                    >
                      ...
                      <p className="text-white text-[16px] lg:text-[24px] font-extrabold leading-[150%] lg:leading-[140%] text-center">
                        {item?.number}+
                      </p>
